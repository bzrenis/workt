...
class CalculationService {
  ...
  calculateDailyEarnings(workEntry, settings) {
    ...
    if (isStandbyDay && settings?.standbySettings?.enabled) {
      ...
      console.log(`[CalculationService] Attivata indennità reperibilità per ${workEntry.date}: ${standbyAllowance}€`);
    }
    
    console.log(`[CalculationService] Indennità reperibilità per ${workEntry.date}: ${standbyAllowance}€ (manuale: ${isManuallyActivated}, disattivata: ${isManuallyDeactivated}, calendario: ${isInCalendar})`);
