...
// ...componenti ModernCard, SectionHeader, InputRow, ModernSwitch, ModernButton, InfoBadge, TimeFieldModern, EarningsSummary, veicoloOptions, dayTypes, iconsConfig, TypeIcon, completamentoOptions, categoryLabels...

const TimeEntryForm = ({ route, navigation }) => {
  // ...tutti gli stati, hooks, useEffect, handler, render, return, ecc. come nel file originale...
  // Qui sotto la funzione di salvataggio con il fix targa:
  ...
  // ...resto del render e return, con onPress={handleSave} sul pulsante Salva...
};
